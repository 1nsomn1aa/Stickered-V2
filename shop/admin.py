...
from .models import (
    Product, Category, SizeType, SizeOption, Order, OrderItem
)
...
class OrderAdmin(admin.ModelAdmin):
    list_display = (
        'id', 'full_name', 'email', 'shipping_method', 'shipping_cost',
        'total_amount', 'status', 'tracking_number', 'created_at'
    )
    readonly_fields = (
        'first_name', 'last_name', 'email', 'address_line1',
        'address_line2', 'city', 'eir_code', 'country', 'shipping_method',
        'shipping_cost', 'total_amount', 'created_at', 'full_name',
        'address_display',
    )
    ...
    fieldsets = (
        ...
        ('Shipping Address', {
            'fields': (
                ...
                'eir_code', 'country', 'address_display'
            )
        }),
        ('Order Details', {
            'fields': (
